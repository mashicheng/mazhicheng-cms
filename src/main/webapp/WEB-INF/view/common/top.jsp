			...
			<c:choose>
				...
				<c:when test="${sessionScope.user!= null}">
					<li class="nav-item"><a class="nav-link" href="/my/home">
							<img alt="" src="/pic/${sessionScope.user.picture}"
					...
					<li class="nav-item">
						<div class="dropdown" style="padding-top: 0.4rem;">
							...
							<div class="dropdown-menu dropdown-menu-right"
								...
								<a class="dropdown-item" href="/rep/loginout">退出</a>
							</div>
						</div>
					</li>
				</c:when>
				<c:otherwise>
					<%-- 未登录显示登录注册链接 --%>
					<li class="nav-item"><a class="nav-link" href="/rep">注册</a></li>
					<li class="nav-item"><a class="nav-link" href="/rep/login">登录</a></li>
				</c:otherwise>
			</c:choose>
		</ul>
	</nav>
