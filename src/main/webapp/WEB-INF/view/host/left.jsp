...
<ul class="sidebar navbar-nav" >
	...
	<li class="nav-item"><a class="nav-link"  href="javascript:void(0)" data="/admin/sel_article">
			<i class="fas fa-fw fa-folder"></i> <span>文章管理</span>
	</a></li>

	<li class="nav-item"><a class="nav-link"  href="javascript:void(0)" data="/admin/sel_users">
	...
	<li class="nav-item"><a class="nav-link" href="javascript:void(0)" data="/admin/selspecial">
